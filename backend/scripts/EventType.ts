...
export type BirdieEvent = FluidIntakeObservationEvent | TaskCompletedEvent | PhysicalHealthObservationEvent | VisitCompletedEvent | CheckOutEvent | MoodObservationEvent | RegularMedicationTakenEvent | AlertRaisedEvent | NoMedicationObservationReceivedEvent | IncontinencePadObservationEvent | CheckInEvent | GeneralObservationEvent | RegularMedicationNotTakenEvent | FoodIntakeObservationEvent | TaskCompletionRevertedEvent | MentalHealthObservationEvent | MedicationScheduleUpdatedEvent | VisitCancelledEvent | RegularMedicationMaybeTakenEvent | MedicationScheduleCreatedEvent | AlertQualifiedEvent | TaskScheduleCreatedEvent | ConcernRaisedEvent | RegularMedicationPartiallyTakenEvent | CatheterObservationEvent | ToiletVisitRecordedEvent