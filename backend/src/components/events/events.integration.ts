...
describe('events integration', () => {
  ...
  beforeAll(async () => {
    connectionCleanup = await typeORMConnectionLoader();
  });
  ...
  describe('GET /v1/events', () => {
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d'
      );
    ...
    then response
      ...
      const res = await request(app).get(
        `/api/v1/events?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d&timeRangeStart=${encodeURIComponent(
          TEST_EVENTS[0].timestamp
        )}`
      );
      expect(res.status).toEqual(200);
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d&limit=1'
      );
      expect(res.status).toEqual(200);
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d&skip=1'
      );
      expect(res.status).toEqual(200);
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d&skip=foo'
      );
  ...
  describe('GET /v1/events/aggregate', () => {
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/aggregate?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d'
      );
      expect(res.status).toEqual(200);
      expect(res.body).toEqual(
    ...
    then response
      ...
      const res = await request(app).get(
        '/api/v1/events/aggregate?careRecipientId=df50cac5-293c-490d-a06c-ee26796f850d&timeRangeStart=2019-05-12T18%3A30%3A07.000Z'
      );
      expect(res.status).toEqual(200);
      expect(res.body).toEqual(
        expect.objectContaining({
...
const TEST_EVENTS = [
  ...
  },
  {
    ...
    alertId: null,
    taskInstanceId:
      'bXw3YmU3M2M3NC0zYzZkLTQ2ZjQtYWViMC01YzJmNTczMThiYWF8MjAxOS0wNS0xMlQxOTowMDowMC4wMDBa',
    visitId: '5cd753f0-8b66-f8a8-43f7-330f62a3e1d6',
    caregiverId: 'f7a00df5-bbc4-4ad7-9918-c07e16e709f6',
    payloadAsText:
      '{"id": "5b044315-01a5-4879-9059-523733fdb33c", "visit_id": "5cd753f0-8b66-f8a8-43f7-330f62a3e1d6", "timestamp": "2019-05-12T19:30:01+01:00", "event_type": "regular_medication_taken", "caregiver_id": "f7a00df5-bbc4-4ad7-9918-c07e16e709f6", "medication_type": "SCHEDULED", "task_instance_id": "bXw3YmU3M2M3NC0zYzZkLTQ2ZjQtYWViMC01YzJmNTczMThiYWF8MjAxOS0wNS0xMlQxOTowMDowMC4wMDBa", "care_recipient_id": "df50cac5-293c-490d-a06c-ee26796f850d"}',
